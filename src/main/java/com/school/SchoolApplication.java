...
public class SchoolApplication {
    ...
    public CommandLineRunner demo(SchoolService schoolService,
        ...
        return args -> {
            ...
            Student s1 = studentService.create(Student.builder()
                    .firstName("Nura").lastName("Bro").age(19).gpa(3.8).group("SE-23").build());

            Student s2 = studentService.create(Student.builder()
            ...
            Teacher teacher1 = teacherService.create(Teacher.builder()
                    .firstName("Amir").lastName("Black").subject("Calculus 2").degree("Master").build());

            Teacher teacher2 = teacherService.create(Teacher.builder()
